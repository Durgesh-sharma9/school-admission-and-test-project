...
const QrLinksPage = () => {
  ...
  const getPublicLink = () => {
    ...
    return `${origin}/public/college/admission/${targetId}`;
  };
  ...
  const handleDownload = async (format) => {
    ...
    try {
      ...
      const fileNameClean = (name || 'College').replace(/[^a-zA-Z0-9_-]/g, '_');
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <span className="text-[11px] text-slate-500 font-medium">
                        Direct student application & reception registration links
                      </span>
                    </div>
                  </div>
                  <button
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[10px] text-emerald-600 font-semibold bg-emerald-50 px-2 py-0.5 rounded border border-emerald-100">For Students / WhatsApp</span>
                    </div>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[10px] text-amber-600 font-semibold bg-amber-50 px-2 py-0.5 rounded border border-amber-100">Desk Kiosk</span>
                    </div>
                    <div className="flex items-center gap-1.5 bg-slate-50 border border-slate-200 rounded-xl p-1.5 pl-3 focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-500/20 transition-all">
