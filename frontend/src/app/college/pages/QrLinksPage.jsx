                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-1 bg-slate-50 border border-slate-100 rounded-xl p-1 pl-2">
                    ...
                    <button
                      ...
                      className="p-1.5 hover:bg-slate-200/50 rounded-lg text-slate-500 shrink-0 transition-colors"
                    >
                      {copyingReception ? <Check className="h-3 w-3 text-indigo-650 font-black" /> : <Copy className="h-3 w-3" />}
                    </button>
                    <a
                      href={receptionLink}
                      target="_blank"
            ...
            <div className="space-y-6 pb-20 relative">
              ...
              <div className="bg-white rounded-3xl border border-slate-200/80 shadow-3xs overflow-hidden transition-all duration-200 hover:shadow-2xs">
                <button
                  ...
                  className="w-full flex items-center justify-between py-4 px-5 text-slate-855 font-extrabold text-sm hover:bg-slate-50/50 transition-colors border-b border-slate-150/40"
                >
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          {logo && (
                            <button
                              ...
                              className="px-2.5 py-1.5 rounded-lg border border-red-105 text-[10px] font-semibold text-red-650 bg-white hover:bg-red-550 flex items-center gap-1 hover:text-white transition-colors"
                            >
              ...
              <div className="bg-white rounded-3xl border border-slate-200/80 shadow-3xs overflow-hidden transition-all duration-200 hover:shadow-2xs">
                <button
                  ...
                  className="w-full flex items-center justify-between py-4 px-5 text-slate-855 font-extrabold text-sm hover:bg-slate-55/50 transition-colors border-b border-slate-150/40"
                >
                  <div className="flex items-center gap-2 text-slate-700">
