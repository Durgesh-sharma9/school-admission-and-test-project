...
const SupportModeBanner = ({ schoolName, onExit }) => {
  return (
    <div className="bg-red-600 text-white px-6 py-2.5 flex items-center justify-between shadow-md shrink-0 border-b border-red-700">
      <div className="flex items-center space-x-3 text-xs sm:text-sm font-bold tracking-wide">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <span className="text-red-200 hidden md:inline">• You are logged in as Super Admin</span>
        </div>
      </div>
      <Button
        onClick={onExit}
        className="bg-white text-red-700 hover:bg-red-50 text-xs font-black px-3 py-1.5 shadow-sm border border-transparent"
      >
