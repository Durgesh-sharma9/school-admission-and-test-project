...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 bottom-0 left-0 z-45 flex flex-col w-64 text-slate-100 border-r border-slate-900 transition-transform duration-300 ease-in-out lg:translate-x-0 ${
