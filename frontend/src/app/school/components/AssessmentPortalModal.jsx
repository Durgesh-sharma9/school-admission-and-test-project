      ...
      try {
        ...
        const createNewPage = () => {
          ...
          header.innerHTML = '<div><h1 style="font-size: 18px; font-weight: 900; color: #0f172a; margin: 0; text-transform: uppercase; letter-spacing: 0.5px;">Detailed Evaluation</h1>' +
            '<div style="font-size: 10.5px; color: #475569; margin-top: 2px; font-weight: 700; text-transform: uppercase;">' + ${JSON.stringify(schoolName)} + ' • ' + ${JSON.stringify(enquiry.studentName)} + ' — ' + ${JSON.stringify(assessment.name)} + '</div></div>' +
        ...
        if (cards.length > 0) {
          ...
          cards.forEach((card) => {
            ...
            if (currentHeight + cardHeight > pageHeightLimit && questionsContainer.children.length > 1) {
