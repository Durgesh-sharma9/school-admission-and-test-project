...
const QrLinksPage = () => {
  ...
  const mainTitleText = qrBranding.posterTitle?.trim() || 'School Admission Portal';
    ...
    try {
      ...
      if (response.success) {
        ...
        if (updateSchoolState) {
          updateSchoolState({ ...school, ...response.school, institutionType: 'school' });
        }
      }
    } catch (err) {
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: name || 'School Admission Portal',
          url: publicLink
        });
      } catch { }
    } else {
          ...
          <>
            ...
            <div className="w-full flex flex-col items-center space-y-4 pt-4">
              {qrBranding.showLogo && displayLogo ? (
                <img src={displayLogo} crossOrigin="anonymous" className="h-32 w-32 object-contain p-2 rounded-2xl bg-slate-50 border shadow-2xs" alt="logo" />
              ) : (
                qrBranding.showLogo && <div style={{ color: effectivePrimary }} className="h-28 w-28 bg-indigo-50 border rounded-2xl flex items-center justify-center font-black text-4xl">S</div>
              )}
              {qrBranding.showName && (
            ...
            <div className="flex justify-between items-center border-b-4 border-indigo-900/10 pb-6">
              ...
              {qrBranding.showLogo && (
                displayLogo ? (
                  ...
                  <div style={{ color: effectivePrimary }} className="h-24 w-24 bg-indigo-50 border rounded-2xl flex items-center justify-center font-black text-3xl shrink-0">S</div>
                )
              )}
            </div>
            ...
            <div className="w-full flex flex-col items-center space-y-4 pt-4">
              {qrBranding.showLogo && (
                displayLogo ? (
                  ...
                  <div className="h-28 w-28 bg-amber-500/10 border border-amber-500/40 rounded-full flex items-center justify-center font-black text-amber-500 text-3xl">S</div>
                )
              )}
              {qrBranding.showName && (
                <div className="space-y-2">
            ...
            <div className="w-full p-6 bg-white/10 backdrop-blur-md border border-white/25 rounded-3xl flex items-center justify-between gap-4">
              ...
              {qrBranding.showLogo && (
                displayLogo ? (
                  ...
                  <div className="h-16 w-16 bg-white/20 rounded-xl flex items-center justify-center font-black text-xl shrink-0">S</div>
                )
              )}
            </div>
            ...
            <div className="flex flex-col items-center space-y-5 my-auto">
              ...
              <div className="p-5 bg-white/95 border-2 border-white/40 rounded-3xl shadow-xl flex items-center justify-center">
                {displayQr ? (
                  ...
                  <div className="h-56 w-56 bg-purple-100 flex items-center justify-center text-purple-400 text-base rounded-2xl">Scan QR</div>
                )}
              </div>
            ...
            <div className="w-full flex items-center justify-between border-b border-white/10 pb-5">
              ...
              {qrBranding.showLogo && (
                displayLogo ? (
                  ...
                  <div className={`h-16 w-16 rounded-xl flex items-center justify-center font-black text-xl shrink-0 ${themeMode === 'bw' ? 'bg-slate-200 text-slate-700' : 'bg-white/20 text-white'}`}>S</div>
                )
              )}
            </div>
            ...
            <div className="flex flex-col items-center space-y-5 my-auto">
              ...
              <div className="p-5 bg-white rounded-3xl shadow-xl flex items-center justify-center">
                {displayQr ? (
                  ...
                  <div className="h-56 w-56 bg-indigo-50 flex items-center justify-center text-indigo-400 text-base rounded-2xl">Scan QR</div>
                )}
              </div>
          ...
          <div className={`col-span-12 md:col-span-8 lg:col-span-4 space-y-6 order-2 lg:order-2 ${activeTab === 'branding' ? 'block' : 'hidden md:block lg:block'}`}>
            <div className="space-y-6 pb-20 relative">
              ...
              <div className="bg-white rounded-xl border border-slate-200 border-l-4 border-l-[#7C3AED] shadow-sm overflow-hidden card-lift hover:border-slate-300 hover:shadow-md transition-all duration-200">
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="icon-circle bg-[#EDE9FE] p-1.5 rounded-full">
                      <Sparkles className="h-4 w-4 text-[#7C3AED]" />
                    </div>
                    <div className="text-left flex flex-col">
                      <span className="text-[17px] font-bold text-slate-900 leading-none">Branding Identity</span>
                      <span className="text-[12px] text-slate-500 font-normal mt-1">Manage school logo and visual branding</span>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-xl border border-slate-200 border-l-4 border-l-[#EA580C] shadow-sm overflow-hidden card-lift hover:border-slate-300 hover:shadow-md transition-all duration-200">
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="icon-circle bg-[#FED7AA] p-1.5 rounded-full">
              ...
              <div className="bg-white rounded-xl border border-slate-200 border-l-4 border-l-[#16A34A] shadow-sm overflow-hidden card-lift hover:border-slate-300 hover:shadow-md transition-all duration-200">
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="icon-circle bg-[#DCFCE7] p-1.5 rounded-full">
              ...
              <div className="bg-white rounded-xl border border-slate-200 border-l-4 border-l-[#CA8A04] shadow-sm overflow-hidden card-lift hover:border-slate-300 hover:shadow-md transition-all duration-200">
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="icon-circle bg-[#FEF08A] p-1.5 rounded-full">
              ...
              <div className="bg-white rounded-xl border border-slate-200 border-l-4 border-l-[#DB2777] shadow-sm overflow-hidden card-lift hover:border-slate-300 hover:shadow-md transition-all duration-200">
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="icon-circle bg-[#FCE7F3] p-1.5 rounded-full">
