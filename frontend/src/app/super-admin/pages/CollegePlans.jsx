  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-[50vh]">
        ...
        <span className="ml-3 font-semibold text-slate-600">Loading College Plans...</span>
      </div>
    );
  }

  return (
    <div className="max-w-4xl mx-auto text-left pb-12">
      {/* Page Header */}
      <div className="mb-6 mt-2">
        <h1 className="text-[24px] font-bold text-slate-800 tracking-tight leading-[1.2]">College CRM Subscription Plans</h1>
        <p className="text-slate-500 text-[15px] font-medium mt-1">
          Configure prices, statuses, and features for University & College Premium subscriptions.
        </p>
      </div>
      ...
      <div className="max-w-md">
        {plans.map((plan) => (
          ...
          >
            ...
            <div className="p-6 bg-gradient-to-r from-[#8B5CF6] to-[#A78BFA] text-white">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 gap-2.5">
                  {plan.features.map((feat, index) => (
                    <div key={index} className="flex items-center space-x-2.5 text-slate-650 text-xs">
                      <span className="text-[#8B5CF6] font-extrabold font-sans">✓</span>
          ...
          <form onSubmit={handleSave} className="space-y-6 text-left">
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                <input
                  type="text"
                  placeholder="Add custom feature description... e.g. 10GB Cloud Storage"
                  value={newFeature}
