    ...
    <div className="space-y-4 text-left bg-slate-900 text-slate-100 min-h-screen">
      ...
      <div className="flex items-center justify-between border-b border-slate-800 pb-3">
        <div>
          ...
          <p className="text-slate-400 text-[11px] mt-0.5">Configure platform branding, SMTP mailer configurations, and operations mode</p>
        </div>
      </div>

      <form onSubmit={handleSave} className="space-y-4 max-w-4xl">
        {/* General Settings */}
        <div className="bg-slate-800/40 rounded-2xl border border-slate-800 p-5 shadow-lg">
          ...
          <div className="space-y-3.5">
            <div>
              ...
              <input
                ...
                placeholder="School Admission CRM"
        ...
        <div className="bg-slate-800/40 rounded-2xl border border-slate-800 p-5 shadow-lg">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h2 className="text-base font-bold text-white">SMTP Settings</h2>
          </div>
          ...
          <div className="space-y-3.5">
            ...
            <div>
              ...
              <input
                ...
                placeholder="noreply@schoolcrm.com"
                className="w-full px-3 py-1.5 bg-slate-900 border border-slate-700 rounded-xl text-white placeholder-slate-500 text-xs focus:outline-none focus:border-indigo-500"
              />
            </div>
        ...
        <div className="bg-slate-800/40 rounded-2xl border border-slate-800 p-5 shadow-lg">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3.5 bg-slate-900/50 border border-slate-800 rounded-xl">
              <div>
                <p className="font-bold text-white text-xs">Maintenance Mode</p>
                <p className="text-[10px] text-slate-400 mt-0.5">Disable the platform temporarily for database operations or updates</p>
              </div>
              <button
                type="button"
        ...
        <div className="flex justify-end pt-2">
          <Button
            ...
            className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-xs font-bold tracking-wide transition shadow-md shadow-indigo-600/10 px-4 py-2"
          >
